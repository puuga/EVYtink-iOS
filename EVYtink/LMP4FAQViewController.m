...
#import "LMP4FAQViewController.h"
#import "SWRevealViewController.h"

@interface LMP4FAQViewController ()

@end

@implementation LMP4FAQViewController
@synthesize webV;
...
- (void)viewDidLoad {
    ...
    NSURLRequest *requestObj = [NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://evbt.azurewebsites.net/docs/page/theme/evytinkreport.aspx"]]];
