...
@protocol P1D1TableViewCellControllerDelegate <NSObject>
...
@interface P1D1TableViewCell : UITableViewCell
...
@property (assign, nonatomic) id<P1D1TableViewCellControllerDelegate> delegate;
