...
@implementation P1CellCustom3
@synthesize strObjId,indexAction,btLikeOutlet,urlToShow,img,EvyUserId,lbComment,lbLike,userPostId;
...
-(void)chkStatusLike{
    ...
    [manager GET:URL.absoluteString parameters:nil success:^(NSURLSessionTask *task, id responseObject){
        ...
        //NSLog(@"Index row - %d",indexAction.row);
